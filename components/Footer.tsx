           ...
           <div className="flex flex-col items-center md:items-start">
            ...
            <div className="space-y-3 text-[var(--color-text-secondary)]">
              ...
              <div className="flex justify-center md:justify-start space-x-4">
                 <a href="https://www.instagram.com/beinggauravbisht/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[var(--color-text-inverted)] hover:text-[var(--color-text-secondary)] transition-colors">
                    <UserIcon className="h-5 w-5" />
